// SDK test script em JavaScript para integração Sui
const { SuiClient } = require("@mysten/sui.js/dist/cjs/client");
const { TransactionBlock } = require("@mysten/sui.js/dist/cjs/transactions");
